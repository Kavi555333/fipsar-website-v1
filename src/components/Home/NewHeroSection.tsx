...
const NewHeroSection: React.FC = () => {
  ...
  return (
    <section 
      className="relative w-full min-h-screen flex items-center py-12 mt-16 sm:mt-16 lg:mt-4 lg:py-0 overflow-hidden"
      style={{
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 animate-fade-in">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-4xl  font-medium leading-tight text-[#006FF6]">
                ...
                Transforming Life  Sciences Through Data AI & <br/> Compliance Excellence
