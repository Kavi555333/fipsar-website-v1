...
const MoleculeIcon = () => (
  ...
  const ArrowTargetIcon = () => (
    ...
    >
      ...
      <circle cx="10" cy="14" r="2" fill="#006FF6" stroke="none" />
      
      {/* Arrow hitting the center */}
      <path d="M21 3L11.5 12.5" strokeWidth="2.5" />
      <path d="M21 3l-3 1.5M21 3l-1.5 3" /> {/* Fletching */}
      <path d="M12 11l-2 3 3-2z" fill="#006FF6" stroke="none" /> {/* Arrow tip in bullseye */}
    </svg>
  ); 
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-20 pt-28 md:pt-44">
        ...
        <div className={`max-w-4xl mx-auto text-center mb-10 entrance-anim ${isVisible ? 'visible' : ''}`}>
          <h1 className="capitalize text-[30px] md:text-[34px] font-bold text-[#006FF6] leading-[1.3] md:leading-[1.25] tracking-tight">
            Intelligent platforms  <span className="text-[#424242] cursor-default">& </span> AI solutions  <span className="text-[#424242] cursor-default">built for</span>  <br className="hidden md:block" />
             <span className="text-[#424242] cursor-default"> the Life Sciences ecosystem.</span>
          </h1>
        </div>
