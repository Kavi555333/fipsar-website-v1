...
import s2 from '../../assets/Services/dataengineering/2RealTime.png'
import s3 from '../../assets/Services/dataengineering/3Clouddata.jpg'
import s4 from '../../assets/Services/dataengineering/4snowflakeimp.jpg'
import s5 from '../../assets/Services/dataengineering/5masterdata.jpg'
import s6 from '../../assets/Services/dataengineering/6automated.png'
import s7 from '../../assets/Services/dataengineering/7perfromace.png'
...
const SLIDE_ITEMS: SliderItem[] = [
  {
    ...
    image: "https://boomi.com/wp-content/uploads/blog-seointegrating-legacy-systems-1-1.jpg"
  },
  {
    id: 2,
...
const BUSINESS_VALUE_POINTS = [
  "Faster & reliable data access",
  "Reduced system complexity",
  "Scalable & resilient architecture",
  "Lower operational costs",
  "Improved reporting & analytics performance",
...
// --- Main Container ---
export const DataEngineeringNew: React.FC = () => {
  return (
    ...
    <div className="w-full flex justify-center px-6 sm:px-10 lg:px-16 py-12">
        <div className="max-w-4xl text-center">
            ...
            We design and implement enterprise-grade data platforms that unify
            clinical, commercial and operational data into a single source of
            truth. Our data engineering solutions ensure your data is cloud-ready,
            reliable and optimized for analytics, AI and reporting.
            </p>
        </div>
    </div>
