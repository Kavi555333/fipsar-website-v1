...
import s1 from '../../assets/Services/Datgoverance/1Datagover.jpeg'
import s2 from '../../assets/Services/Datgoverance/2metadata.png'
import s3 from '../../assets/Services/Datgoverance/3rolebasesec.jpg'
import s4 from '../../assets/Services/Datgoverance/1Datagover.jpeg'
import s5 from '../../assets/Services/Datgoverance/5privacy.webp'
import s6 from '../../assets/Services/Datgoverance/6Riskass.avif'
import s7 from '../../assets/Services/Datgoverance/7policy.webp'
import s8 from '../../assets/Services/Datgoverance/3rolebasesec.jpg'
  ...
  return (
    <section className="w-full max-w-[1240px] mx-auto flex flex-col gap-8">
      <div className="flex items-end justify-between px-6">
        <h2 className="text-2xl md:text-3xl font-black tracking-tight" style={{ color: '#006FF6' }}>Compliance Standards Supported</h2>
...
// --- Main Container ---
export const DatagovernaceNew: React.FC = () => {
  return (
    ...
    <div className="w-full flex justify-center px-6 sm:px-10 lg:px-16 py-12">
        <div className="max-w-4xl text-center">
            ...
            Enable Trusted, Secure & Compliant Data
            </h3>
