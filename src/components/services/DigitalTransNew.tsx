...
import s1 from '../../assets/Services/digitaltransformation/1digitalatranf.jpg'
import s2 from '../../assets/Services/digitaltransformation/2Cloudmigra.jpg'
import s3 from '../../assets/Services/digitaltransformation/3legacy.jpg'
import s4 from '../../assets/Services/digitaltransformation/4Intelligentaut.jpg'
import s5 from '../../assets/Services/digitaltransformation/5Applicationmoder.avif'
import s6 from '../../assets/Services/digitaltransformation/6changemanagemnt.jpg'
import s7 from '../../assets/Services/digitaltransformation/7Businessproc.png'
import s8 from '../../assets/Services/digitaltransformation/8techarch.jpg'
...
// --- Main Container ---
export const DigitalTransNew: React.FC = () => {
  return (
    ...
    <div className="w-full flex justify-center px-6 sm:px-10 lg:px-16 py-12">
        <div className="max-w-4xl text-center">
            ...
            Accelerate Modernization & Innovation
            </h3>
