...
import herobg from '../../assets/Services/salesforce/1SALESFORCE.jpg'
...
const DEFAULT_ITEMS: TechItem[] = [
  ...
  { id: '5', name: ' APIs & Integrations',         icon: apiint },
];
...
export const Salesforce: React.FC<SliderProps> = () => {
      ...
      <section className="py-24 mt-8 relative overflow-hidden">
        ...
        <div className=" container mx-auto px-6 relative z-10 ">
            ...
            <div className="order-1 lg:order-1">
                ...
                {/* <span className="text-sm font-bold tracking-widest text-[#006FF6] uppercase">
                    Data Engineering
                </span> */}
    ...
    {/*             
                ...
                <h2 className="text-3xl md:text-3xl lg:text-3xl font-bold  mb-6 leading-tight">
