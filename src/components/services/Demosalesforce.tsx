...
import De1 from '../../assets/Services/salesforce/1SALESFORCE.jpg'
import De2 from '../../assets/Services/salesforce/2Salesforcehealth.webp'
import De3 from '../../assets/Services/salesforce/7Salesmanaged.png'
import De4 from '../../assets/Services/salesforce/4Commercial.webp'
import De5 from '../../assets/Services/salesforce/5Process.png'
import De6 from '../../assets/Services/salesforce/6Compliance.webp'
import De7 from '../../assets/Services/salesforce/7Salesmanaged.png'





import snowflake    from '../../assets/Salesforceicons/saleslife.png'
import Talend       from '../../assets/Salesforceicons/healthcloud.jpg'
import Databricks  from '../../assets/Salesforceicons/crm.jpg'
import aws          from '../../assets/Salesforceicons/cloud-service.svg'
...
const VALUE_PROPS: ValueProp[] = [
  { id: 1, text: " Unified view of HCPs and patients", icon: Zap },
  { id: 2, text: " Improved commercial and medical engagement", icon: Layers },
  { id: 3, text: "Faster, insight-driven decision-making", icon: ShieldCheck },
  { id: 4, text: " Compliance-ready CRM operations", icon: TrendingDown },
  { id: 5, text: "Scalable platform for growth", icon: BarChart3 },
  { id: 6, text: "Reduced operational overhead through managed services", icon: Cpu },
];
...
const DEFAULT_ITEMS: TechItem[] = [
  { id: '1', name: 'Salesforce Life Sciences Cloud ',   icon: snowflake },
  { id: '2', name: 'Salesforce Health Cloud',      icon: Talend     },
  { id: '3', name: ' CRM Analytics',  icon: Databricks },
  { id: '4', name: 'Service Cloud ',         icon: aws },
