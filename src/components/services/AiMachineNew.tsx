...
import s1 from '../../assets/Services/aiintelligence/1predictiv.jpg'
import s2 from '../../assets/Services/aiintelligence/2Generative.jpg'
import s3 from '../../assets/Services/aiintelligence/3Recommend.webp'
import s4 from '../../assets/Services/aiintelligence/4Intelligent.jpg'
import s5 from '../../assets/Services/aiintelligence/5onversational.jpg'
import s6 from '../../assets/Services/aiintelligence/6AI.webp'
import s7 from '../../assets/Services/aiintelligence/7Model.jpg'
import s8 from '../../assets/Services/aiintelligence/8AI.png'
...
const SLIDE_ITEMS: SliderItem[] = [
  ...
  },
  {
    ...
    description: "versioning and continuous updates. This orchestration guarantees scalable, dependable and efficiently maintained AI systems.",
    image: s6
  },
  {
    id: 7,
...
// --- Main Container ---
export const AiMachineNew: React.FC = () => {
  return (
    ...
    <div className="w-full flex justify-center px-6 sm:px-10 lg:px-16 py-12">
        <div className="max-w-4xl text-center">
           ...
           Unlock Predictive Intelligence & Automation
            </h3>
